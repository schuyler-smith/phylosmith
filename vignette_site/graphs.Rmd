...
***Usage***
```r
phylogeny_bars_ggplot(phyloseq_obj, classification, treatment, subset = NULL, merge = TRUE, relative_abundance = FALSE, colors = 'default')
```
...
```{r phylogeny_bars_ggplot}
phylogeny_bars_ggplot(soil_column, classification = 'phylum', treatment = c('Matrix', 'Treatment'), merge = TRUE, relative_abundance = TRUE)
```
