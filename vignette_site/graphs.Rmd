...
***Examples***
```{r network_phyloseq, eval=F}
network <- network_phyloseq(taxa_filter(soil_column, frequency = 0.8), treatment = c('Matrix', 'Treatment'), subset = 'Soil_Manure', co_occurrence_table = NULL, classification = 'genus')
