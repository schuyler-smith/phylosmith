...
abundance_heatmap_ggplot(derep_sc, classification = 'Phylum', treatment = c('Matrix', 'Treatment'), subset = 'Soil', transformation = 'log10')
```
...
abundance_lines_ggplot(derep_sc, classification = 'Phylum', treatment = c('Matrix', 'Treatment'), subset = 'Soil', relative_abundance = TRUE)
```
...
***Examples***
```{r network_ps}
network_ps(soil_column, treatment = c('Matrix', 'Treatment'), subset = 'Soil Amended', co_occurrence_table = NULL, classification = 'Phylum')
```
...
phylogeny_profile_ggplot(derep_sc, classification = 'Phylum', treatment = c('Matrix', 'Treatment'), subset = 'Soil', merge = TRUE, relative_abundance = TRUE)
```
...
taxa_abundance_bars_ggplot(taxa_filter(soil_column, frequency = 0.8), classification = 'Phylum', treatment = c('Matrix', 'Treatment'), subset = 'Unamended', transformation = 'mean')
```
