...
abundance_heatmap_ggplot(soil_column, classification = 'phylum', treatment = c('Matrix', 'Treatment'), subset = 'Soil', transformation = 'log10')
```
...
abundance_lines_ggplot(conglomerate_samples(soil_column, treatment = c('Matrix', 'Treatment'), merge_on = 'Day'), classification = 'phylum', treatment = c('Matrix', 'Treatment'), subset = 'Soil', relative_abundance = TRUE)
```
...
***Usage***
```r
network_ps(phyloseq_obj, treatment = NULL, subset = NULL, co_occurrence_table = NULL, classification = NULL, node_colors = 'default', cluster = FALSE, cluster_colors = 'default', buffer = 0.5)
```
...
***Examples***
```{r network_ps}
network_ps(soil_column, treatment = c('Matrix', 'Treatment'), subset = 'Soil Manure', co_occurrence_table = NULL, classification = 'phylum')
```
...
Create an layout_igraph object of the co-occurrence from a phyloseq object. This can be input into the network_ps function, or used for other network creating scripts. The purpose is to be able to create reproducible and comparable graphics.
...
***Examples***
```{r network_layout_ps}
network_layout_ps(soil_column, treatment = c('Matrix', 'Treatment'), subset = 'Soil Manure', algorithm = 'kk')
```
...
phylogeny_profile_ggplot(soil_column, classification = 'phylum', treatment = c('Matrix', 'Treatment'), subset = 'Soil', merge = TRUE, relative_abundance = TRUE)
```
