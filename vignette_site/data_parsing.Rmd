...
taxa_filter(soil_column, treatment = 'Matrix', subset = 'Manure')
```
```{r conglomerate_samples}
conglomerate_samples(soil_column, treatment = 'Matrix', subset = 'Manure', merge_on = 'Day')
```
```{r conglomerate_samples_otu, echo=FALSE}
conglomerate_samples(soil_column, treatment = 'Matrix', subset = 'Manure', merge_on = 'Day')
```
...
ordered_days <- order_treatment(soil_column, 'Day', 'numeric')
