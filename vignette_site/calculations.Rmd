...
```{r co_occurrence}
co_occurrence_table <- co_occurrence(soil_column, treatment = c('Matrix', 'Treatment'), subset = 'Amended', rho = 0.8, p = 0.05)
co_occurrence_table
```
...
```{r permute_rho}
permuted_rhos <- permute_rho(soil_column, treatment = c('Matrix', 'Treatment'), subset = 'Amended', replicate_samples = 'Day', permutations = 5)
permuted_rhos
```
