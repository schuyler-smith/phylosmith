...
#' @usage merge_asvs(...)
#' @param ... Any number of \linkS4class{phyloseq-class} objects created with the \link[=phyloseq]{phyloseq} package (must have Amplicon Sequence Variants for calling taxa).
#' @keywords manip
#' @export
#' @import phyloseq
