...
#' \code{\link{order_treatment}} sets the orders of the factors in a sample_data column (for ordering graphs)
#'
...
#'
#' \code{\link{merge_treatments}} combines multiple columns in meta-data into a single column
#'
